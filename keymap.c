...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_split_3x6_3(
          ...
          KC_ENT,  HOME_A,  HOME_S,  HOME_D,  HOME_F, KC_QUES,                  KC_DOT,    KC_4,    KC_5,    KC_6, KC_ASTR, XXXXXXX,
         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_EXLM,                    KC_0,    KC_1,    KC_2,    KC_3,  KC_EQL, _______,
