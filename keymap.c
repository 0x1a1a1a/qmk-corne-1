...
*/
    ...
    [1] = LAYOUT_split_3x6_3(
            ...
            UNDO, XXXXXXX,   SPC_L,   MCTRL,   SPC_R,   ALFRD,         KC_MUTE, KC_BRIU, KC_SLEP, XXXXXXX, XXXXXXX, XXXXXXX,
            REDO,     DND,  KC_ESC,  KC_TAB,  KC_ENT,   EMOJI,         KC_VOLU, KC_RCMD, KC_ROPT, KC_RSFT, KC_RCTL, XXXXXXX,
         LANG_EN, XXXXXXX,  XXXXXXX,    CUT,    COPY,   PASTE,         KC_VOLD, KC_BRID, XXXXXXX, XXXXXXX,  SS_OPT, LANG_UA,
                                      TO(3),  KC_SPC,   TO(1),           TO(2), KC_BSPC,   TO(4)
