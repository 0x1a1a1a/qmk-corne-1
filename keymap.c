...
*/
    ...
    [0] = LAYOUT_split_3x6_3(
         ...
         XXXXXXX,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,            KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  CYR_KH,
          KC_ESC,  HOME_A,  HOME_S,  HOME_D,  HOME_F,    KC_G,            KC_H,  HOME_J,  HOME_K,  HOME_L, HOME_SC, KC_QUOT,
         XXXXXXX,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, XXXXXXX,
                                    XXXXXXX,  KC_SPC,   TO(1),         XXXXXXX, KC_BSPC,   TO(3)
    ...
    [1] = LAYOUT_split_3x6_3(
         ...
         XXXXXXX, XXXXXXX, XXXXXXX,   KC_UP, XXXXXXX,   LANG,            ALFRD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MUTE,
          KC_ESC, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT,   EMOJI,           ONEPS,  HOME_J,  HOME_K,  HOME_L, HOME_SC, KC_VOLU,
             DND,   TAB_P,   TAB_N,   SPC_L,   MCTRL,   SPC_R,          SS_OPT,  SS_C_A,  SS_C_S,  SS_F_A,  SS_F_S, KC_VOLD,
                                     KC_ENT,  KC_SPC,   TO(2),           TO(0), KC_BSPC,  KC_TAB
    ...
    [2] = LAYOUT_split_3x6_3(
         ...
         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ASTR,         KC_PLUS,    KC_7,    KC_8,    KC_9,  KC_DOT, XXXXXXX,
          KC_ESC,  HOME_A,  HOME_S,  HOME_D,  HOME_F, KC_SLSH,         KC_MINS,    KC_4,    KC_5,    KC_6, KC_COMM, XXXXXXX,
         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_EQL,            KC_0,    KC_1,    KC_2,    KC_3, XXXXXXX, XXXXXXX,
                                     KC_ENT,  KC_SPC,   TO(0),           TO(0), KC_BSPC, KC_TAB
    ...
    [3] = LAYOUT_split_3x6_3(
          ...
          KC_GRV,   DLLR, KC_LBRC,    ATSGN,    NMBR, KC_RBRC,          KC_DOT,  KC_GRV, XXXXXXX, XXXXXXX, XXXXXXX, KC_BSLS,
          KC_ESC,   CARET, RDBRC_L, KC_EXLM, KC_QUES, RDBRC_R,         KC_COMM, KC_MINS,   NDASH,   MDASH, XXXXXXX, XXXXXXX,
         XXXXXXX, XXXXXXX, KC_LCBR,   PRCNT,   AMPRD, KC_RCBR,           COLON, KC_SCLN, KC_QUOT,  D_QUOT,  UNDRSC, XXXXXXX,
                                     KC_ENT,  KC_SPC, XXXXXXX,           TO(0), KC_BSPC,   TO(4)
    ),

    // SPECIAL CHARACTERS: CYRILLIC
    [4] = LAYOUT_split_3x6_3(

         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          CYR_PD,  KC_GRV,  CYR_KH,  CYR_II, XXXXXXX, XXXXXXX,
          KC_ESC, XXXXXXX, RDBRC_L,CYR_EXLM,CYR_QUES, RDBRC_R,          CYR_CM, KC_MINS,   NDASH,   MDASH,   CYR_E, XXXXXXX,
         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,         CYR_CLN,CYR_SCLN,  CYR_QT, CYR_DQT,  UNDRSC, XXXXXXX,
                                     KC_ENT,  KC_SPC, XXXXXXX,           TO(0), KC_BSPC,   TO(3)
    )
