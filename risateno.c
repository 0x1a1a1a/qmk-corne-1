    ...
    [5] = LAYOUT_split_3x6_3(
         ...
         _______,    KC_L,    KC_D,    KC_R,    KC_J, _______,                 _______, _______, _______, _______, _______, _______,
         _______,    KC_U,    KC_V,    KC_M,    KC_F, _______,                 _______, _______, _______, _______, _______, _______,
...
combo_t key_combos[COMBO_COUNT] = {
    COMBO(en, LANG_EN), // Switch to Layer: MAIN + English layout
    COMBO(ua, LANG_UA), // Switch to Layer: MAIN + Ukrainian layout
    COMBO(numpad, TO(2)), // Switch to Layer: NUMPAD
    COMBO(arrows, TO(3)), // Switch to Layer: ARROWS
    COMBO(special, TO(4)), // Switch to Layer: SPECIAL CHARACTERS
